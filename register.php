    ...
    <script type="text/javascript">
      ...
      <div class="register">
        ...
        <form action="?" method="POST">
          ...
          <p>By creating an account, you are agreeing to our <a href ="#">Terms of Service</a>. For more information, please check <a href="#">DevPortal's privacy policy</a>. We may occasionally send you account-related emails.</p>
        </form>
      </div>
      <?php
          echo $error;
